...
**Commercial** Admin Dashboard coded in [Django Framework](https://www.djangoproject.com/) on top of **[DattaAble Dashboard](https://django-dashboard-dattaable-pro.appseed.us/login/)** design (PRO Version) designed by **CodedThemes** Agency - product generated by AppSeed.
...
- Access the [product page](https://appseed.us/admin-dashboards/django-dashboard-dattaable-pro) and purchase a **license**
...
- Clone the source code and build the [Django Dashboard DattaAble PRO](https://appseed.us/admin-dashboards/django-dashboard-dattaable-pro) using the instructions presented in this documentation.
...
> Note: this is a private repository. To get access, you should buy a license from the [product page](https://appseed.us/admin-dashboards/django-dashboard-dattaable-pro). 

<br />

```bash
$ # Get the code
$ git clone https://github.com/app-generator/priv-django-dashboard-dattaable-pro.git
$ cd priv-django-dashboard-dattaable-pro
$
...
![Django Dashboard DattaAble PRO - Main Screen.](https://raw.githubusercontent.com/app-generator/static/master/django-dashboard-dattaable-pro/django-dashboard-dattaable-pro-screen-1.png)

<br />

![Django Dashboard DattaAble PRO - Charts Screen.](https://raw.githubusercontent.com/app-generator/static/master/django-dashboard-dattaable-pro/django-dashboard-dattaable-pro-screen-3.png)

<br />

![Django Dashboard DattaAble PRO - Widgets Screen.](https://raw.githubusercontent.com/app-generator/static/master/django-dashboard-dattaable-pro/django-dashboard-dattaable-pro-screen-4.png)
